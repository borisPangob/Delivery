...
public class InProgressActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    public void onItemClick(int position) {
        ...
        Toast.makeText(this, "itinéraire OSM "+mission.getId(), Toast.LENGTH_SHORT).show();
        myIntent = new Intent(InProgressActivity.this, ItineraryActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() ==R.id.itemOnHold){
            myIntent = new Intent(InProgressActivity.this, OnHoldActivity.class);
            startActivity(myIntent);
            finish();
        }else if (item.getItemId() ==R.id.itemInProgress){
            myIntent = new Intent(InProgressActivity.this, InProgressActivity.class);
            startActivity(myIntent);
            finish();
        }else if (item.getItemId() ==R.id.itemHistorique){
            myIntent = new Intent(InProgressActivity.this, DriverHistoryActivity.class);
            startActivity(myIntent);
            finish();
        } else if (item.getItemId() ==R.id.itemProfil) {
            myIntent = new Intent(InProgressActivity.this, ProfilActivity.class);
            startActivity(myIntent);
            finish();
